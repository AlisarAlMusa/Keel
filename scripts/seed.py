...
_COURSES: list[dict[str, Any]] = [
    # --- Original 24 ---
    {"code": "CS101", "name": "Intro to Programming", "credits": 3, "difficulty": 2, "terms": ["fall", "spring"], "desc": "Foundations of programming in Python."},
    {"code": "CS102", "name": "Data Structures", "credits": 3, "difficulty": 3, "terms": ["fall", "spring"], "desc": "Lists, trees, graphs, and complexity."},
    {"code": "CS201", "name": "Algorithms", "credits": 3, "difficulty": 4, "terms": ["fall"], "desc": "Design and analysis of algorithms."},
    {"code": "CS202", "name": "Computer Systems", "credits": 4, "difficulty": 4, "terms": ["spring"], "desc": "Architecture, memory, and the OS interface."},
    {"code": "CS210", "name": "Discrete Math for CS", "credits": 3, "difficulty": 3, "terms": ["fall", "spring"], "desc": "Logic, sets, combinatorics, proofs."},
    {"code": "CS301", "name": "Databases", "credits": 3, "difficulty": 3, "terms": ["fall"], "desc": "Relational modeling, SQL, transactions."},
    {"code": "CS302", "name": "Operating Systems", "credits": 4, "difficulty": 5, "terms": ["spring"], "desc": "Processes, scheduling, concurrency."},
    {"code": "CS310", "name": "Computer Networks", "credits": 3, "difficulty": 4, "terms": ["fall"], "desc": "Layered protocols and the Internet."},
    {"code": "CS320", "name": "Software Engineering", "credits": 3, "difficulty": 3, "terms": ["spring"], "desc": "Design, testing, and team workflows."},
    {"code": "CS330", "name": "Machine Learning", "credits": 3, "difficulty": 5, "terms": ["fall", "spring"], "desc": "Supervised and unsupervised learning."},
    {"code": "CS340", "name": "Human-Computer Interaction", "credits": 3, "difficulty": 3, "terms": ["spring"], "desc": "Usability and interface design."},
    {"code": "CS350", "name": "Cloud Computing", "credits": 3, "difficulty": 4, "terms": ["fall"], "desc": "Virtualization, containers, scaling."},
    {"code": "CS401", "name": "Distributed Systems", "credits": 3, "difficulty": 5, "terms": ["fall"], "desc": "Consistency, replication, consensus."},
    {"code": "CS402", "name": "Compilers", "credits": 4, "difficulty": 5, "terms": ["spring"], "desc": "Lexing, parsing, code generation."},
    {"code": "CS410", "name": "Computer Security", "credits": 3, "difficulty": 4, "terms": ["fall"], "desc": "Threats, cryptography, secure design."},
    {"code": "CS420", "name": "Capstone Project", "credits": 4, "difficulty": 4, "terms": ["spring"], "desc": "Team-built software capstone."},
    {"code": "MATH101", "name": "Calculus I", "credits": 4, "difficulty": 3, "terms": ["fall", "spring"], "desc": "Limits, derivatives, integrals."},
    {"code": "MATH102", "name": "Calculus II", "credits": 4, "difficulty": 4, "terms": ["spring"], "desc": "Series, techniques of integration."},
    {"code": "MATH201", "name": "Linear Algebra", "credits": 3, "difficulty": 3, "terms": ["fall"], "desc": "Vectors, matrices, eigenvalues."},
    {"code": "MATH210", "name": "Probability & Statistics", "credits": 3, "difficulty": 4, "terms": ["spring"], "desc": "Distributions, inference, estimation."},
    {"code": "PHYS201", "name": "Physics I", "credits": 4, "difficulty": 4, "terms": ["fall"], "desc": "Mechanics and motion."},
    {"code": "PHYS201L", "name": "Physics I Lab", "credits": 1, "difficulty": 2, "terms": ["fall"], "desc": "Companion lab for Physics I."},
    {"code": "ENG101", "name": "Technical Writing", "credits": 3, "difficulty": 2, "terms": ["fall", "spring"], "desc": "Clear written communication."},
    {"code": "ECON101", "name": "Microeconomics", "credits": 3, "difficulty": 2, "terms": ["fall", "spring"], "desc": "Markets, incentives, pricing."},
    # --- New DS (7) ---
    {"code": "DS210", "name": "Data Science Fundamentals", "credits": 3, "difficulty": 3, "terms": ["fall", "spring"], "desc": "Data wrangling, EDA, and visualization."},
    {"code": "DS301", "name": "Statistical Learning", "credits": 3, "difficulty": 4, "terms": ["fall"], "desc": "Regression, classification, and model selection."},
    {"code": "DS310", "name": "Data Engineering", "credits": 3, "difficulty": 4, "terms": ["fall"], "desc": "Pipelines, warehousing, and batch/stream processing."},
    {"code": "DS320", "name": "Applied Machine Learning", "credits": 3, "difficulty": 4, "terms": ["spring"], "desc": "Feature engineering, ensemble methods, deployment."},
    {"code": "DS340", "name": "Natural Language Processing", "credits": 3, "difficulty": 5, "terms": ["spring"], "desc": "Text classification, embeddings, LLMs."},
    {"code": "DS350", "name": "Deep Learning", "credits": 3, "difficulty": 5, "terms": ["fall"], "desc": "Neural networks, CNNs, RNNs, and transformers."},
    {"code": "DS401", "name": "Data Science Capstone", "credits": 4, "difficulty": 4, "terms": ["spring"], "desc": "End-to-end data science project."},
    # --- New Chem (13) ---
    {"code": "CHEM101", "name": "General Chemistry I", "credits": 4, "difficulty": 3, "terms": ["fall", "spring"], "desc": "Atomic structure, bonding, and stoichiometry."},
    {"code": "CHEM101L", "name": "General Chemistry I Lab", "credits": 1, "difficulty": 2, "terms": ["fall", "spring"], "desc": "Lab companion for General Chemistry I."},
    {"code": "CHEM102", "name": "General Chemistry II", "credits": 4, "difficulty": 4, "terms": ["fall", "spring"], "desc": "Equilibrium, kinetics, and thermodynamics."},
    {"code": "CHEM201", "name": "Organic Chemistry I", "credits": 4, "difficulty": 5, "terms": ["fall"], "desc": "Structure, bonding, and reactions of organic compounds."},
    {"code": "CHEM201L", "name": "Organic Chemistry I Lab", "credits": 1, "difficulty": 3, "terms": ["fall"], "desc": "Lab companion for Organic Chemistry I."},
    {"code": "CHEM202", "name": "Organic Chemistry II", "credits": 4, "difficulty": 5, "terms": ["spring"], "desc": "Aromatic compounds, carbonyl reactions, synthesis."},
    {"code": "CHEM301", "name": "Analytical Chemistry", "credits": 3, "difficulty": 4, "terms": ["fall"], "desc": "Quantitative analysis, spectroscopy, chromatography."},
    {"code": "CHEM310", "name": "Physical Chemistry", "credits": 3, "difficulty": 5, "terms": ["fall"], "desc": "Thermodynamics, kinetics, and quantum mechanics."},
    {"code": "CHEM311", "name": "Physical Chemistry II", "credits": 3, "difficulty": 5, "terms": ["spring"], "desc": "Statistical mechanics and spectroscopy."},
    {"code": "CHEM320", "name": "Biochemistry", "credits": 3, "difficulty": 4, "terms": ["spring"], "desc": "Biomolecules, metabolism, and enzyme kinetics."},
    {"code": "CHEM330", "name": "Inorganic Chemistry", "credits": 3, "difficulty": 4, "terms": ["spring"], "desc": "Coordination compounds, organometallics."},
    {"code": "CHEM410", "name": "Advanced Analytical Chemistry", "credits": 3, "difficulty": 5, "terms": ["fall"], "desc": "NMR, MS, and advanced separation techniques."},
    {"code": "CHEM420", "name": "Chemistry Capstone Research", "credits": 4, "difficulty": 4, "terms": ["spring"], "desc": "Original research project under faculty supervision."},
]
...
_PROGRAMS: list[dict[str, Any]] = [
    {"code": "BSCS", "name": "Bachelor of Science in Computer Science", "degree_type": "BS", "total_credits": 120, "description": "Core CS degree with algorithms, systems, and electives."},
    {"code": "BSDS", "name": "Bachelor of Science in Data Science", "degree_type": "BS", "total_credits": 120, "description": "Interdisciplinary degree combining CS, statistics, and data engineering."},
    {"code": "BSCHEM", "name": "Bachelor of Science in Chemistry", "degree_type": "BS", "total_credits": 120, "description": "Classical chemistry degree with research capstone."},
]

_PROGRAM_REQS: dict[str, list[dict[str, Any]]] = {
    "BSCS": [
        {"group": "CS Core", "credits": 21, "courses": ["CS101", "CS102", "CS201", "CS202", "CS301", "CS302", "CS320"]},
        {"group": "Capstone", "credits": 4, "courses": ["CS420"]},
        {"group": "CS Electives", "credits": 9, "courses": ["CS310", "CS330", "CS340", "CS350", "CS401", "CS402", "CS410"]},
    ...
    "BSDS": [
        {"group": "DS Core", "credits": 16, "courses": ["DS210", "DS301", "DS320", "DS401", "CS301"]},
        {"group": "Methods", "credits": 6, "courses": ["CS330", "DS310"]},
        {"group": "DS Electives", "credits": 6, "courses": ["DS340", "DS350", "CS350"]},
        {"group": "Math & Stats", "credits": 14, "courses": ["MATH101", "MATH102", "MATH201", "MATH210"]},
        {"group": "Programming", "credits": 6, "courses": ["CS101", "CS102"]},
        {"group": "General Education", "credits": 6, "courses": ["ENG101", "ECON101"]},
    ],
    "BSCHEM": [
        {"group": "Chem Core", "credits": 22, "courses": ["CHEM101", "CHEM102", "CHEM201", "CHEM202", "CHEM301", "CHEM310"]},
        {"group": "Labs", "credits": 2, "courses": ["CHEM101L", "CHEM201L"]},
        {"group": "Chem Electives", "credits": 9, "courses": ["CHEM311", "CHEM320", "CHEM330", "CHEM410"]},
        {"group": "Capstone", "credits": 4, "courses": ["CHEM420"]},
        {"group": "Supporting Science", "credits": 13, "courses": ["MATH101", "MATH102", "PHYS201", "PHYS201L"]},
        {"group": "General Education", "credits": 6, "courses": ["ENG101", "ECON101"]},
    ],
}
...
_TERM_SLOTS: list[list[dict[str, int | str]]] = [
    [{"day": "mon", "start_min": 540, "end_min": 615}, {"day": "wed", "start_min": 540, "end_min": 615}],
    [{"day": "tue", "start_min": 600, "end_min": 675}, {"day": "thu", "start_min": 600, "end_min": 675}],
    [{"day": "mon", "start_min": 660, "end_min": 735}, {"day": "wed", "start_min": 660, "end_min": 735}],
    [{"day": "tue", "start_min": 480, "end_min": 555}, {"day": "thu", "start_min": 480, "end_min": 555}],
    [{"day": "mon", "start_min": 780, "end_min": 855}, {"day": "fri", "start_min": 780, "end_min": 855}],
]
